    ...
    <div className="bg-slate-800 shadow-2xl shadow-violet-700/30 min-w-[350px] px-[35px] py-[25px] flex flex-col items-center z-10 rounded">
      ...
      <form className=" w-full flex flex-col items-center" action="">
        <div className="relative my-2 w-full">
          ...
          <input className="w-full rounded active:bg-transparent bg-transparent border-[1px] border-white/30  px-4 py-3" placeholder="Email" type="email" name="email" id="email" />
        </div>
        <div className="relative w-full mt-[25px]">
          ...
          <input className="w-full rounded bg-transparent border-[1px] border-white/30  px-4 py-3" placeholder="password" type="email" name="email" id="email" />
        </div>
      ...
      <div className="social_icons my-2 w-[50%] flex flex-row justify-around">
        <button className="bg-transparent border-[1px] p-3 border-white/20 rounded-full">
          <Image width={25} height={25} src={"https://cdn.iconscout.com/icon/free/png-256/free-google-1772223-1507807.png"} />
        </button>
        <button className="bg-transparent border-[1px] p-3 border-white/20 rounded-full">
          <Image color="white" width={25} height={25} src={"https://www.edigitalagency.com.au/wp-content/uploads/facebook-icon-black-circle-white-png.png"} />
        </button>
      </div>
